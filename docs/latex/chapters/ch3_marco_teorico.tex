...
En este trabajo se utilizan algoritmos de ordenamiento iterativos clásicos: Bubble Sort optimizado, Insertion Sort, Selection Sort optimizado y Cocktail Shaker Sort. Estos métodos permiten reordenar los registros de deportistas según distintos criterios, como ID, nombre, equipo, puntaje o cantidad de competencias. Aunque todos cumplen la misma función general, presentan diferencias en su rendimiento dependiendo de si la entrada se encuentra ordenada, desordenada o invertida.
