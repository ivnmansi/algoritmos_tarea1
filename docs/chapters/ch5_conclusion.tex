...
\begin{itemize}
    \item \textbf{Franco Aguilar}: Elementos base del programa (estructura de datos, gnuplot, lógica de menús), revisión de documentación, casos de prueba para el análisis de datos experimentales,implementación de insertion sort y búsqueda secuencial.
    \item \textbf{Iván Mansilla}: Elementos base del programa (estructura de datos, printing, parseo de CSV, comandos de terminal, base de gnuplot, makefile) e implementación de Bubble Sort optimizado y Selection Sort optimizado.
